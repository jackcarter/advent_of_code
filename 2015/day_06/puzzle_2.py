...
class Grid:
	...
	def __init__(self):
		self.lights = [[0 for ii in range(self.side_length)] for jj in range(self.side_length)]
	...
	def off(self, c1, c2, r1, r2):
		self._apply_to_rectangle(c1,c2,r1,r2,lambda x: max(x - 1, 0))

	def on(self, c1, c2, r1, r2):
		self._apply_to_rectangle(c1,c2,r1,r2,lambda x: x + 1)

	def toggle(self, c1, c2, r1, r2):
		self._apply_to_rectangle(c1,c2,r1,r2,lambda x: x + 2)
